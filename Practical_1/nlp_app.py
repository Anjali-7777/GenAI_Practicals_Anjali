...
# ------------------------------------------------------------------
st.set_page_config(
    page_title="NLP Analysis Studio - Anjali Patalbansi",
    page_icon="🧠",
    layout="wide",
...
default_text = (
    "Microsoft is developing innovative artificial intelligence tools for students. "
    "The company is working with researchers in Hyderabad to improve language technologies."
)
...
<div class="nlp-hero">
    ...
    <h2>Anjali Patalbansi - 12/08/2026</h2>
    <p>Explore essential Natural Language Processing techniques using <b>NLTK</b> and <b>spaCy</b>.
     Enter your own text, select an NLP operation, and visualize the results interactively.</p>
    <div class="badge-row">
